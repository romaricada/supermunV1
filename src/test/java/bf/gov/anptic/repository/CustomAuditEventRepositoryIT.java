...
import bf.gov.anptic.config.audit.AuditEventConverter;
import bf.gov.anptic.domain.PersistentAuditEvent;
...
import static bf.gov.anptic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

...
public class AccountResourceIT {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(contactMailService, userRepository, userService, mockMailService);

        AccountResource accountUserMockResource =
            new AccountResource(contactMailService, userRepository, mockUserService, mockMailService);

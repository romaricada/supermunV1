 ...
 */
public class TypeIndicateursDTO extends AbstractAuditingDTO implements Serializable {
    ...
    private List<DomainesDTO> domaines = new ArrayList<>();
    ...
    public List<DomainesDTO> getDomaines() {
        return domaines;
    }

    public void setDomaines(List<DomainesDTO> domaines) {
    ...
    public boolean equals(Object o) {
        ...
        TypeIndicateursDTO typeIndicateurDTO = (TypeIndicateursDTO) o;

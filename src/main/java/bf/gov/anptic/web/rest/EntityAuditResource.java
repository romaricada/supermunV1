...
import bf.gov.anptic.domain.EntityAuditEvent;
import bf.gov.anptic.repository.EntityAuditEventRepository;
...
public class EntityAuditResource {
    ...
    public ResponseEntity<List<EntityAuditEvent>> getChanges(@RequestParam(value = "entityType") String entityType,
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(UriComponentsBuilder.fromUri(URI.create("/api/audits/entity/changes")),page);
